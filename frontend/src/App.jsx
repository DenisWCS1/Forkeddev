...
function App() {
  return (
    <div className="  border-t-pink-500 border-8 flex flex-row">
      ...
      J'utilise le CSS Perso</p>      
      <p className="bg-blueDuck-100 text-5xl mr-6 my-5">J'utilise le CSS Perso
      </p>      
      <p className="bg-blueSimple-100 text-5xl mr-6 my-5">
      J'utilise le CSS Perso
      </p>      
      <p className="bg-turquoise-100 text-5xl mr-6 my-5">J'utilise le CSS Perso
      </p>      
